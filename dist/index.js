...
const fetch = __nccwpck_require__(2493)
...
module.exports = global.fetch = global.fetch || (
	typeof process=='undefined' ? r(__nccwpck_require__(3970)) : (function(url, opts) {
...
const cloudFlareWorkersKV = __nccwpck_require__(282);
